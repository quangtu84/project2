...
VL_MODULE(Vtop) {
  public:
    ...
    // LOCAL VARIABLES
    // Internals; generally not touched by application code
    CData/*0:0*/ top__DOT__top__DOT____Vcellinp__player_1__cannot_walk_through_i;
  ...
  public:
    ...
    static void _multiclk__TOP__21(Vtop__Syms* __restrict vlSymsp);
    static void _multiclk__TOP__24(Vtop__Syms* __restrict vlSymsp);
    static void _multiclk__TOP__25(Vtop__Syms* __restrict vlSymsp);
